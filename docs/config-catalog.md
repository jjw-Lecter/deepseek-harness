...
Source: [`packages/client/ui-deepseek-balance/src/config.ts:35`](../packages/client/ui-deepseek-balance/src/config.ts)
...
Source: [`packages/client/ui-quick-start/src/config.ts:30`](../packages/client/ui-quick-start/src/config.ts)
