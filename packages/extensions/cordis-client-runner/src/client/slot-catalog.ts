...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-quick-start QuickStartAppPanel',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'sidebar\' (client-ui-sidebar), so it exists while that entry is mounted',
    occupants: [
      'client-ui-deepseek-balance DeepSeekBalanceBadge id \'deepseek-balance\'',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'sidebar.brand.status\', () => ctx.slots.register(\n      { name: \'sidebar.brand.status\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'sidebar\' (client-ui-sidebar), so it exists while that entry is mounted',
    occupants: [
      'client-ui-quick-start QuickStartPanelIcon',
    ],
    replaceRisk: 'none',
  ...
  {
    key: 'sidebar.quickstart',
    kind: 'single',
    scope: 'root',
    summary: 'Launch actions directly under New Session: the ways into work that is not a blank session.',
    doc: 'Launch actions directly under New Session: the ways into work that is\nnot a blank session. Declared by this package\'s \'sidebar\' entry; the\noccupant owns its own button set, and the shell passes only its column\nstate. Absent a registrant the shell draws nothing here.',
    registerOptions: [],
    ownerProps: [
    ...
    declaredBy: 'an entry in \'sidebar\' (client-ui-sidebar), so it exists while that entry is mounted',
    occupants: [
      'client-ui-quick-start QuickStartButtons',
    ],
    replaceRisk: 'shadows-shipped-ui',
