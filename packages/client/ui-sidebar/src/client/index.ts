...
export type {
  SidebarBrandMarkOwnerProps, SidebarBrandNameOwnerProps, SidebarBrandStatusOwnerProps,
  SidebarFooterActionOwnerProps,
  SidebarPanelIconOwnerProps, SidebarPanelMetadata, SidebarQuickstartOwnerProps,
...
export function apply(ctx: ClientContext): void {
  ...
  ctx.slots.inject('sidebar', () => ctx.slots.register({
    ...
    children: {
      ...
      'sidebar.brand.status': { kind: 'list', scope: 'root' },
