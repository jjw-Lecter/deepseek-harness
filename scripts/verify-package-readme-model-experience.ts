...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-quick-start': { kind: 'indirect', reason: 'The seat writes a composer draft; the session the user then sends it in owns every model-visible effect.' },
  ...
  'packages/client/ui-deepseek-balance': { kind: 'none', reason: 'Browser-side sidebar balance cell and its host-only provider read; the amount never enters a model request.' },
